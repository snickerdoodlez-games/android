      ...
      {showDef && catDict && createPortal(
        ...
        <m.div
          ...
          <m.div
            ...
            <h2 className="text-[clamp(1.25rem,5vw,2rem)] font-black font-raleway uppercase text-white text-center tracking-wider leading-tight mb-1 animate-focus-in-expand" style={{ animationDelay: '0.25s' }}>{name}</h2>
