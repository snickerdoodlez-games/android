 ...
 * Includes caching to avoid expensive string splitting on every level load.
 */
export const getThemedDataMap = (): Map<string, CSVRow[]> => {
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    // Theme data follows THEME, CATEGORY, WORD1, WORD2... format
